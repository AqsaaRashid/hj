...
<div class="max-w-3xl mx-auto px-6">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h2 class="text-2xl font-bold">Create Addon Group</h2>
        <p class="text-gray-400 text-sm mt-1">
            Add a new addon group for menu modifiers
        </p>
    </div>
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-lg p-8">
        ...
        <form action="{{ route('admin.addon-groups.store') }}" method="POST" class="space-y-6">
            @csrf
