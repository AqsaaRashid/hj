...
<div class="max-w-3xl mx-auto px-6">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h2 class="text-2xl font-bold">Create Flavor</h2>
        <p class="text-gray-400 text-sm mt-1">
            Add a flavor option for an addon
        </p>
    </div>
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-lg p-8">
        ...
        <form action="{{ route('admin.addon-flavors.store') }}"
              method="POST"
              class="space-y-6">
            ...
            <div>
                ...
                <input type="text"
                       name="flavor"
                       required
                       placeholder="Example: Mango, Strawberry, Oreo"
                       class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3
                              focus:outline-none focus:ring-2 focus:ring-yellow-500
                              focus:border-yellow-500 transition">
            </div>
